...
namespace Magistral40.Models
{
    public class Cryptography
    {
        ...
        public string Shifrovka(string ishText, string pass,
        ...
        public  string DeShifrovka(string ciphText, string pass,
               string sol = "sapbpccool!!!", string cryptographicAlgorithm = "SHA1",
               int passIter = 2, string initVec = "a8doSuDitOz1hZe#",
               int keySize = 256)
        {
